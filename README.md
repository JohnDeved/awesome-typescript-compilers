...
| [Mako](https://github.com/umijs/mako) | Rust-based web bundler for apps, libraries, and frameworks. ([playground](https://codesandbox.io/p/devbox/mako-jzhkjh?embed=1&file=%2Fsrc%2FApp.tsx)) |
...
| [vite-node](https://github.com/antfu-collective/vite-node) | Vite-powered Node runtime with TS support; its repo now points new projects to Vite’s built-in Module Runner. |
