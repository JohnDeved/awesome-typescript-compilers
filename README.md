...
| [bun](https://github.com/Jarred-Sumner/bun) | `runtime` | Incredibly fast JavaScript runtime, bundler, transpiler and package manager. ([online demo](https://replit.com/@coetry/bun?v=1)) |
